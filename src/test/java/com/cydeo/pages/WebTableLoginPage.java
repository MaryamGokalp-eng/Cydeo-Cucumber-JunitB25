...
public class WebTableLoginPage {
    ...
    public void login(){
        ...
        /**
         * Create a logic on above code use THIS Keyword referring to object and refer to the element
         */
    }
     ...
     * U can have multiple version of login
     * @param username
     * @param password
     */
    ...
    /**
     * This method read the data direct from the configuration properties and will log in using credentials from
